...
**The front page is an edition, not a list.** It comes out four times a day, at hours you set, and carries ten stories, or fifteen, or twenty, as you prefer : several articles, from several rooms, about one thing, and about that edition's own hours. Each edition wears a list of three points at most, written on your device, over the whole page, in your language. An aggregator shows what arrived and leaves you to work out what matters. Past editions are kept for good, under the page : pull past the foot of today's paper and the archive opens, a few numbers at a time as you scroll. What did not fit is in the wire next door.
...
**And you can see what it all adds up to.** A page of figures beside your own face, over a day, a season or the lot : the articles received, how many stories they came to, the sources they came from, the hour of the day, the day of the week and the day of the month your feeds are busiest, the subjects, the people, the authors and the languages. No unread count, no streak, nothing that scores you.
