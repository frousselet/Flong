...
**And you can see what it all adds up to.** A page of figures beside your own face, over a day, a season or the lot : the articles received, the sources they came from, the hour of the day your feeds are busiest, the subjects, the people, the authors, the languages, how many arrived twice, and which feeds carry the whole article and which carry a headline and a link. No unread count, no streak, nothing that scores you.
