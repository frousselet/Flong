...
**The front page is an edition, not a list.** It comes out four times a day, at hours you set, and carries ten stories : several articles, from several rooms, about one thing, and about that edition's own hours. Each edition wears a list of three points at most, written on your device, over the whole page, in your language. An aggregator shows what arrived and leaves you to work out what matters. Past editions are kept, and what did not fit is in the wire next door.
