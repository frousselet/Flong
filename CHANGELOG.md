...
- Collections : starring or annotating an article copies it whole, so it survives the purge of the stream and the disappearance of its source, and what is kept is handed to Spotlight and found in the system search.
