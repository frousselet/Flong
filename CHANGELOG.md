...
- The digest opens on its date rather than on its own name, and refreshes on a pull and on returning to the foreground, the Mac keeping the command in its toolbar.
