...
- Subjects across the page, found by the system model and shown as pills that scroll, the front page first : a story is under one subject, a subject covering a single story is dropped, and without a model there are no pills and the front page is entire.
