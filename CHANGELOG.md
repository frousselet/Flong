...
- A reader's menu in the same corner of every section, wearing the reader's own face : an optional name and picture kept in their own iCloud with nowhere to be sent, the sources, every subject there is with what was said about each, including the ones that have fallen off the page, a way to add and remove subjects of their own, the sites they are signed in to, and the command to write the digest again.
