...
- The mark of each source beside its name, in the sources list and on every article row, taken from what the feed states or from the well-known paths a site keeps one at, and falling back to a generic mark rather than a hole.
