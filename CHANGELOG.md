...
- A reader's menu in the digest, holding every subject there is with what was said about each, including the ones that have fallen off the page, and the command to write the digest again.
