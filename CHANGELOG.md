...
- Subjects across the page, found by the system model and shown as pills pinned at the head of it, the front page first : a story is under several subjects or none, and without a model there are no pills and the front page is entire.
