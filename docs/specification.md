...
- **Narrowing to a subject is a question about everything**, so a pill still reads the whole of the three days rather than one period of them. The cap belongs to the edition.
