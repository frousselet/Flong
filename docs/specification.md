...
| Theme | Faces | Colours |
| ----- | ----- | ------- |
| `Défaut` | Serif headlines over a sans body | The system's own, of which it states one : what can be pressed is the ink, black on paper and white at night, rather than the blue every application shares |
