...
**And the dateline stands under the date rather than over the list.** It said which edition this is at the head of the page, which put a second heading under the day the page is already titled with : two lines saying *when*, one above the other, and the reader had read the day before reaching either. A masthead puts the edition under the dateline, and so does this, as the navigation subtitle. It is empty where there is no edition, a subtitle about a page that does not exist being a line saying nothing.
