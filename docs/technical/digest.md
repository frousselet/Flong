...
**Eighteen words a point, and the bound is on the writing rather than on the drawing.** Points at three and four lines apiece were a wall of type before the first headline. What holds a point short is the model : it is asked for at most eighteen words, and nothing anywhere cuts a point that comes back longer, on the front page, in a back number or in the row that opens one. The story standfirsts are uncapped for the same reason.
