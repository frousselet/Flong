...
| The key-value store | Every preference, local and in iCloud : the name, the picture, which body an article opens on, the notices, the searches the reader ran, and the identifier this device writes its archive under |
