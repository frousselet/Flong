...
**Beside the words and not set into them.** Inside the text the glyph would flow with it and land in the middle of a wrapped line on a narrow phone. In its own column the sentence keeps its measure and the mark keeps the margin, which is where a mark about a paragraph has always gone. The button that explains it, on a story's page, wears the same glyph : one mark, one meaning, and the thing a reader presses to ask about it looks like the thing they are asking about.
